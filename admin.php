...
if (isset($_GET["searchstring"])) {
    ...
    $sql = "SELECT * FROM users WHERE name LIKE '%$searchstring%' OR id LIKE '%$searchstring%' ORDER BY name";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "
                     ...
                     <div class='col-12'>
                     <p><a class='a-dark' href='deleteuser.php?id=" . $row["id"] . "'>Delete user</a></p><hr>
                     <p><a class='a-dark' href='updateuser.php?id=" . $row["id"] . "'>Promote user</a></p><hr>
                     </div>";
        }
    } else {
